...
public class MyPushMessageReceiver extends FrontiaPushMessageReceiver {
	...
	public static final String BindSuccess = "cn.changl.safe360.android.recv.push.bind.success";
	public static final String BindFailed = "cn.changl.safe360.android.recv.push.bind.failed";
	...
	public void onBind(Context context, int errorCode, String appid, String userId, String channelId, String requestId) {
		...
		// NotificationHelper.getInstance().showOrUpdateNotification(100,
		// "onBind", "bind", responseString, 0, true, new Intent());
		Intent intent = PushMsgHandleService.createPushMsgIntent(context.getApplicationContext(), "onBind", responseString);
		context.getApplicationContext().startService(intent);

		// 绑定成功，设置已绑定flag，可以有效的减少不必要的绑定请求
		if (errorCode == 0) {
			Utils.setBind(context, true);
			PreferencesUtils.setBaiduChannelId(channelId);
			PreferencesUtils.setBaiduUserId(userId);

			Intent i = new Intent(BindSuccess);
			context.sendBroadcast(i);
		} else {
			Utils.setBind(context, false);
			PreferencesUtils.setBaiduChannelId("");
			PreferencesUtils.setBaiduUserId("");

			Intent i = new Intent(BindFailed);
			context.sendBroadcast(i);
		}
	...
	public void onMessage(Context context, String message, String customContentString) {
		...
		// NotificationHelper.getInstance().showOrUpdateNotification(100,
		// "透传消息", message, customContentString, 0, true, new Intent());
		Intent intent = PushMsgHandleService.createPushMsgIntent(context.getApplicationContext(), message, customContentString);
		context.getApplicationContext().startService(intent);
