...
public class IndexScroller {
	...
	public void drawIndexBarContainer(Canvas canvas) {
		indexbarContainerPaint.setColor(Color.WHITE);
		indexbarContainerPaint.setStrokeWidth(0);
		canvas.drawRect(mIndexbarRect, indexbarContainerPaint);
	...
	public void drawSections(Canvas canvas) {
		indexPaint.setColor(Color.rgb(59, 59, 59));
	...
	public void drawCurrentSection(Canvas canvas) {
		if (mCurrentSection >= 0) {
			...
			RectF previewRect = new RectF((mListViewWidth - previewSize) / 2, (mListViewHeight - previewSize) / 2, (mListViewWidth - previewSize) / 2
					+ previewSize, (mListViewHeight - previewSize) / 2 + previewSize);

			canvas.drawRoundRect(previewRect, 5 * mDensity, 5 * mDensity, previewPaint);
			canvas.drawText(mSections[mCurrentSection], previewRect.left + (previewSize - previewTextWidth) / 2 - 1, previewRect.top + mPreviewPadding
