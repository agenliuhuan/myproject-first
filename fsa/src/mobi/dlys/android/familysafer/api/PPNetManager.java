...
public class PPNetManager {
	...
	// 内部测试服务器
//	private static final String IP = "test.dlys.mobi";
//	private static final int PORT = 20001;
//	private static final String UPLOAD_IP = "test.dlys.mobi:82";
	...
	private static final String APK_DOWNLOAD_PAGE = "http://res.dlys.mobi/download.html";
