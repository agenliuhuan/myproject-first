...
public class AddFamily1Activity extends BaseExActivity {
    ...
    private void initView() {
        ...
        mTitleBar.mRight.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(AddFamily1Activity.this, MainActivity.class);
                startActivity(intent);
                AddFamily1Activity.this.finish();
        ...
        mListview.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (contacts.isRegistered()) {
                    Intent intent = new Intent(AddFamily1Activity.this, FamilyIn1Activity.class);
                    intent.putExtra("extra_user_id", contacts.getUserId());
                    startActivity(intent);
                } else if (contacts.unRegistered()) {
                    Intent intent = new Intent(AddFamily1Activity.this, FamilyOut1Activity.class);
    ...
    private void closeInput() {
        ...
        if (isOpen) {
            imm.hideSoftInputFromWindow(AddFamily1Activity.this.getCurrentFocus().getWindowToken(), 0);
        }
    }
    ...
    private void initData() {
        ...
        if (ReadContactsService.mContactsReadingStatus == 2) {
            sendMessage(YSMSG.REQ_MATCH_PHONE_CONTACTS_LIST, 100, 0, this); // 100:表示该请求来源于注册流程
        }
    }
    ...
    private BroadcastReceiver myBroadcastReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(App.readingStatus)) {
                sendMessage(YSMSG.REQ_MATCH_PHONE_CONTACTS_LIST, 100, 0, AddFamily1Activity.this); // 100:表示该请求来源于注册流程
            }
        }
    };
        ...
        case YSMSG.RESP_MATCH_PHONE_CONTACTS_LIST: {
            ...
            if (msg.arg1 == 200) {
                ...
                if (list != null) {
                    ...
                    if (null != CoreModel.getInstance().getRegisterObject()) {
                        String myPhone = CoreModel.getInstance().getRegisterObject().getPhone();
                    ...
                    holder.btnAddinvite.setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if (contacts.isRegistered()) {
                                ...
                                smsContent += PPNetManager.getInstance().getDownloadPage();
                                smsContent += getResources().getString(R.string.sms_invite2);
                                TelephonyUtils.sendSms(AddFamily1Activity.this, contacts.getPhone(), smsContent, false);
                            }
                        }
                    });
                }
