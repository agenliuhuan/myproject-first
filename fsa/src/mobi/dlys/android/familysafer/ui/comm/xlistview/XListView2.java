package mobi.dlys.android.familysafer.ui.comm.xlistview;
...
public class XListView2 extends FlipperListView implements OnScrollListener {
	...
	private IXListViewListener2 mListViewListener;

	// -- header view
	private XListViewHeader2 mHeaderView;
	...
	private void initWithContext(Context context) {
		...
		// init header view
		mHeaderView = new XListViewHeader2(context);
	...
	public void setXListViewListener(IXListViewListener2 l) {
		mListViewListener = l;
	}
