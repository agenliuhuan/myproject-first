...
public class FileUtils {
	...
	public static final String APP = "FamilySafer";
	public static final String FAMILYSAFER = SDCARD + "/FamilySafer/";
	...
	public static final String AVATAR = SDCARD + "/" + APP + "/cover/avatar.jpg"; // 拍照默认路径
