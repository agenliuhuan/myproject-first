...
//    public static final int CORNER_RADIUS_SMALL = 8;
    ...
    public static void displayAvatar(String uri, ImageView imageView) {
        ...
        ImageLoader.getInstance().displayImage(uri, imageView, imageOptionWithRound(R.drawable.user, true, HEADIMAGE_CORNER_RADIUS));
    ...
    public static void displayImage(String uri, ImageView imageView, int defResId, boolean round, ImageLoadingListener listener, ImageLoadingProgressListener progressListener) {
        if (null == imageView) {
            return;
        }
