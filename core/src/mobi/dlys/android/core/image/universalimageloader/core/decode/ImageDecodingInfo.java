...
public class ImageDecodingInfo {
	...
	/** @return Original {@linkplain mobi.dlys.android.core.image.universalimageloader.utils.MemoryCacheUtils#generateKey(String, ImageSize) image key} (used in memory cache). */
