 ...
 *******************************************************************************/
package mobi.dlys.android.core.image.universalimageloader.core.imageaware;
 ...
 * through {@link mobi.dlys.android.core.image.universalimageloader.core.ImageLoader ImageLoader}.
 * It can wrap any Android {@link android.view.View View} which can be accessed by {@link #getWrappedView()}. Wrapped
 * view is returned in {@link mobi.dlys.android.core.image.universalimageloader.core.listener.ImageLoadingListener ImageLoadingListener}'s
 * callbacks.
 *
...
public interface ImageAware {
	...
	/**
	 * Returns {@linkplain mobi.dlys.android.core.image.universalimageloader.core.assist.ViewScaleType scale type} which is used for
	 ...
	 * {@link mobi.dlys.android.core.image.universalimageloader.core.listener.ImageLoadingListener#onLoadingCancelled(String,
	 ...
	 * {@linkplain mobi.dlys.android.core.image.universalimageloader.core.DisplayImageOptions.Builder#showImageForEmptyUri(
	 *android.graphics.drawable.Drawable) for empty Uri},
	 * {@linkplain mobi.dlys.android.core.image.universalimageloader.core.DisplayImageOptions.Builder#showImageOnLoading(
	 *android.graphics.drawable.Drawable) on loading} or
	 * {@linkplain mobi.dlys.android.core.image.universalimageloader.core.DisplayImageOptions.Builder#showImageOnFail(
	 *android.graphics.drawable.Drawable) on loading fail}. These drawables can be specified in
	 * {@linkplain mobi.dlys.android.core.image.universalimageloader.core.DisplayImageOptions display options}.<br />
	 * Also can be called in {@link mobi.dlys.android.core.image.universalimageloader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
	 ...
	 * {@link mobi.dlys.android.core.image.universalimageloader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
