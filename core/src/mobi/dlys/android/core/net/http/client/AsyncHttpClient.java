...
package mobi.dlys.android.core.net.http.client;
...
import mobi.dlys.android.core.commonutils.ThreadPool;
import mobi.dlys.android.core.net.http.handler.AsyncHttpResponseHandler;
import mobi.dlys.android.core.net.http.request.AsyncHttpRequest;
...
import mobi.dlys.android.core.net.http.request.RetryHandler;
...
public class AsyncHttpClient {
	 ...
	 */
	public AsyncHttpClient() throws NoSuchAlgorithmException,
	...
	public void get(Context context, String url, Header[] headers,
		...
		get(context, url, headers, params, responseHandler, socketTimeout,
				socketTimeout);
	}
	...
	public void get(Context context, String url, Header[] headers,
		...
		try {
			...
			HttpConnectionParams.setSoTimeout(httpParams, soTimeout); // 设置请求超时
			sendRequest(httpClient, httpContext, request, null,
	...
	public void post(Context context, String url, Header[] headers,
			...
			AsyncHttpResponseHandler responseHandler) {
		post(context, url, headers, paramsToEntity(params), contentType,
				responseHandler);
	}
	...
	public void post(Context context, String url, Header[] headers,
			HttpEntity entity, String contentType,
			AsyncHttpResponseHandler responseHandler, int connectionTimeout,
			int soTimeout) {

		HttpPost post = (HttpPost) newHttpMethod("Post", url, null);

		if (null == post) {
			responseHandler.sendFailureMessage(new IllegalArgumentException(
					"the url is invlid."), "the url is invlid.");
			return;
		}

		HttpEntityEnclosingRequestBase request = addEntityToRequestBase(post,
				entity);
		if (headers != null)
			request.setHeaders(headers);
	...
	public void put(Context context, String url, HttpEntity entity,
		...
		sendRequest(httpClient, httpContext,
				addEntityToRequestBase(put, entity), contentType,
				responseHandler, context);
	}
	...
	public void put(Context context, String url, Header[] headers,
		...
		HttpEntityEnclosingRequestBase request = addEntityToRequestBase(put,
				entity);
		if (headers != null)
			request.setHeaders(headers);
		sendRequest(httpClient, httpContext, request, contentType,
	...
	private HttpRequest newHttpMethod(String method, String url,
